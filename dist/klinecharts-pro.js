...
var M5 = (e, t, n) => t in e ? w5(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var u1 = (e, t, n) => (M5(e, typeof t != "symbol" ? t + "" : t, n), n);
import { utils as F, init as S5, FormatDateType as U1, DomPosition as X0, ActionType as T5, dispose as I5, TooltipIconPosition as Y1, registerOverlay as D5 } from "klinecharts";
function N1(e, t, n) {
...
const P5 = {
  ...
  createPointFigures: ({ coordinates: e }) => {
    if (e.length > 1) {
      ...
      const a = N1({ x: e[1].x - 8, y: e[1].y + 4 }, e[1], r), s = N1({ x: e[1].x - 8, y: e[1].y - 4 }, e[1], r);
      return [
        {
          type: "line",
          attrs: { coordinates: e }
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    if (e.length > 1) {
      const n = N9(e[0], e[1]) / Math.sqrt(24), r = e[1].x > e[0].x ? 0 : 1, a = F.getLinearSlopeIntercept(e[0], e[1]);
      let s;
      ...
      for (let c = 2; c < 9; c++) {
        ...
        const I = b + Math.PI / 2, A = N1({ x: C, y: f }, e[0], s);
        l.push({
          ...A,
          r: _,
          startAngle: b,
  ...
  createPointFigures: ({ coordinates: e, bounding: t }) => {
    ...
    if (e.length > 1) {
      ...
      [1, 0.75, 0.618, 0.5, 0.382, 0.25, 0].forEach((f) => {
        ...
        n.push({ coordinates: [{ x: c, y: e[0].y }, { x: c, y: e[1].y }] }), n.push({ coordinates: [{ x: e[0].x, y: _ }, { x: e[1].x, y: _ }] }), r = r.concat(b0([e[0], { x: c, y: e[1].y }], t)), r = r.concat(b0([e[0], { x: e[1].x, y: _ }], t)), a.unshift({
          x: e[0].x + s,
          y: _ + 10,
          text: `${f.toFixed(3)}`
        }), a.unshift({
...
const J5 = !1, W5 = (e, t) => e === t, $0 = Symbol("solid-proxy"), q5 = typeof Proxy == "function", e6 = Symbol("solid-track"), q1 = {
  equals: W5
};
let F9 = R9;
const c1 = 1, e0 = 2, K9 = {
...
var P = null;
let p0 = null, t6 = null, T = null, V = null, o1 = null, l0 = 0;
function X1(e, t) {
  const n = T, r = P, a = e.length === 0, s = t === void 0 ? r : t, o = a ? K9 : {
    owned: null,
    cleanups: null,
...
function s1(e, t, n) {
  F9 = c6;
  const r = c0(e, t, !1, c1);
  (!n || !n.render) && (r.user = !0), o1 ? o1.push(r) : $1(r);
}
function n1(e, t, n) {
  n = n ? Object.assign({}, q1, n) : q1;
  const r = c0(e, t, !0, 0);
...
function r6(e, t, n) {
  ...
  let o = null, i = d0, l = !1, C = "initialValue" in s, f = typeof r == "function" && n1(r);
  const c = /* @__PURE__ */ new Set(), [_, b] = (s.storage || L)(s.initialValue), [I, A] = L(void 0), [K, w] = L(void 0, {
    equals: !1
  }), [Z, N] = L(C ? "ready" : "unresolved");
  function x(M, D, U, Q) {
    return o === M && (o = null, Q !== void 0 && (C = !0), (M === i || D === i) && s.onHydrated && queueMicrotask(() => s.onHydrated(Q, {
      value: D
    })), i = d0, $(D, U)), D;
  }
  function $(M, D) {
    l1(() => {
      D === void 0 && b(() => M), N(D !== void 0 ? "errored" : C ? "ready" : "unresolved"), A(D);
  ...
  function B() {
    ...
    if (U !== void 0 && !o)
      throw U;
    return T && !T.user && M && J0(() => {
      K(), o && (M.resolved || c.has(M) || (M.increment(), c.add(M)));
    }), D;
  }
  function G(M = !0) {
    if (M !== !1 && l)
    ...
    if (U !== void 0) {
      ...
      return x(o, Q, void 0, D), Q;
    return o = Q, "v" in Q ? (Q.s === 1 ? x(o, Q.v, void 0, D) : x(o, void 0, J1(Q.v), D), Q) : (l = !0, queueMicrotask(() => l = !1), l1(() => {
      N(C ? "refreshing" : "pending"), w();
    }, !1), Q.then((t1) => x(Q, t1, void 0, D), (t1) => x(Q, void 0, J1(t1), D)));
  }
...
function i6(e) {
  ...
  return Promise.resolve().then(() => {
    T = t, P = n;
    let r;
    return l1(e, !1), T = P = null, r ? r.done : void 0;
  });
}
let s6;
function Z9() {
...
function Q9(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && l1(() => {
    for (let a = 0; a < e.observers.length; a += 1) {
      const s = e.observers[a], o = p0 && p0.running;
      o && p0.disposed.has(s), (o ? !s.tState : !s.state) && (s.pure ? V.push(s) : o1.push(s), s.observers && z9(s)), o || (s.state = c1);
    }
    if (V.length > 1e6)
      throw V = [], new Error();
  }, !1)), t;
...
function o6(e, t, n) {
  ...
  try {
    ...
    return e.pure && (e.state = c1, e.owned && e.owned.forEach(F1), e.owned = null), e.updatedAt = n + 1, D0(o);
  } finally {
    T = s, P = a;
  }
...
function c0(e, t, n, r = c1, a) {
  ...
  return P === null || P !== K9 && (P.owned ? P.owned.push(s) : P.owned = [s]), s;
}
function t0(e) {
  if (e.state === 0)
    return;
...
function n0(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    ...
    if (r.sources) {
      const a = r.state;
      a === c1 ? r !== t && (!r.updatedAt || r.updatedAt < l0) && t0(r) : a === e0 && n0(r, t);
    }
  }
}
function z9(e) {
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    n.state || (n.state = e0, n.pure ? V.push(n) : o1.push(n), n.observers && z9(n));
  }
}
function F1(e) {
  let t;
...
function C6(e, t, n = {}) {
  ...
  return I0(() => W0(s)), () => {
    ...
    return l[e6], e1(() => {
      let b, I, A, K, w, Z, N, x, $;
      if (C === 0)
        o !== 0 && (W0(s), s = [], r = [], a = [], o = 0, i && (i = [])), n.fallback && (r = [u6], a[0] = X1((B) => (s[0] = B, n.fallback())), o = 1);
      else if (o === 0) {
        for (a = new Array(C), c = 0; c < C; c++)
          r[c] = l[c], a[c] = X1(_);
        o = C;
      } else {
        for (A = new Array(C), K = new Array(C), i && (w = new Array(C)), Z = 0, N = Math.min(o, C); Z < N && r[Z] === l[Z]; Z++)
          ;
        for (N = o - 1, x = C - 1; N >= Z && x >= Z && r[N] === l[x]; N--, x--)
          A[x] = a[N], K[x] = s[N], i && (w[x] = i[N]);
        for (b = /* @__PURE__ */ new Map(), I = new Array(x + 1), c = x; c >= Z; c--)
          $ = l[c], f = b.get($), I[c] = f === void 0 ? -1 : f, b.set($, c);
        for (f = Z; f <= N; f++)
          $ = r[f], c = b.get($), c !== void 0 && c !== -1 ? (A[c] = a[f], K[c] = s[f], i && (w[c] = i[f]), c = I[c], b.set($, c)) : s[f]();
        for (c = Z; c < C; c++)
          c in A ? (a[c] = A[c], s[c] = K[c], i && (i[c] = w[c], i[c](c))) : a[c] = X1(_);
...
function U9(...e) {
  ...
  for (let o = 0; o < e.length; o++) {
    const i = e[o];
    t = t || !!i && $0 in i, e[o] = typeof i == "function" ? (t = !0, n1(i)) : i;
  }
  if (q5 && t)
    return new Proxy({
      get(o) {
...
const g6 = (e) => `Stale read from <${e}>.`;
function m6(e) {
  const t = "fallback" in e && {
    fallback: () => e.fallback
  };
  return n1(C6(() => e.each, e.children, t || void 0));
}
function Y(e) {
  const t = e.keyed, n = n1(() => e.when, void 0, void 0), r = t ? n : n1(n, void 0, {
    equals: (a, s) => !a == !s
  });
  return n1(() => {
    const a = r();
    if (a) {
      const s = e.children;
      return typeof s == "function" && s.length > 0 ? e1(() => s(t ? a : () => {
        if (!e1(r))
          throw g6("Show");
        return n();
      })) : s;
...
function r1(e, t = window.document) {
  ...
  for (let r = 0, a = e.length; r < a; r++) {
    const s = e[r];
    n.has(s) || (n.add(s), t.addEventListener(s, v6));
  }
}
function J(e, t, n) {
...
function r0(e, t, n, r, a) {
  ...
  if (e = o && n[0] && n[0].parentNode || e, s === "string" || s === "number") {
    ...
    if (o) {
      let i = n[0];
      i && i.nodeType === 3 ? i.data !== t && (i.data = t) : i = document.createTextNode(t), n = b1(e, n, r, i);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (x0(i, t, n, a))
        return R(() => n = r0(e, i, n, r, !0)), () => n;
      if (i.length === 0) {
        if (n = b1(e, n, r), o)
          return n;
      } else
        l ? n.length === 0 ? e9(e, i, r) : h6(e, n, i) : (n && b1(e), e9(e, i));
      n = i;
    } else if (t.nodeType) {
      if (Array.isArray(n)) {
        if (o)
...
var _6 = typeof H1 == "object" && H1 && H1.Object === Object && H1, V9 = _6, L6 = V9, b6 = typeof self == "object" && self && self.Object === Object && self, $6 = L6 || b6 || Function("return this")(), a1 = $6, x6 = a1, k6 = x6.Symbol, u0 = k6, t9 = u0, H9 = Object.prototype, A6 = H9.hasOwnProperty, w6 = H9.toString, E1 = t9 ? t9.toStringTag : void 0;
function M6(e) {
  var t = A6.call(e, E1), n = e[E1];
  try {
    e[E1] = void 0;
    var r = !0;
  } catch {
...
var S6 = M6, T6 = Object.prototype, I6 = T6.toString;
function D6(e) {
  return I6.call(e);
}
var P6 = D6, n9 = u0, O6 = S6, B6 = P6, E6 = "[object Null]", N6 = "[object Undefined]", r9 = n9 ? n9.toStringTag : void 0;
function F6(e) {
  return e == null ? e === void 0 ? N6 : E6 : r9 && r9 in Object(e) ? O6(e) : B6(e);
}
var K1 = F6;
function K6(e) {
  var t = typeof e;
...
var k1 = K6, j6 = K1, Z6 = k1, Q6 = "[object AsyncFunction]", R6 = "[object Function]", z6 = "[object GeneratorFunction]", U6 = "[object Proxy]";
function Y6(e) {
  if (!Z6(e))
    return !1;
  var t = j6(e);
  return t == R6 || t == z6 || t == Q6 || t == U6;
}
var G9 = Y6, V6 = a1, H6 = V6["__core-js_shared__"], G6 = H6, _0 = G6, a9 = function() {
...
var J6 = X6, W6 = Function.prototype, q6 = W6.toString;
function ee(e) {
  if (e != null) {
    try {
      return q6.call(e);
...
var X9 = ee, te = G9, ne = J6, re = k1, ae = X9, ie = /[\\^$.*+?()[\]{}|]/g, se = /^\[object .+?Constructor\]$/, oe = Function.prototype, le = Object.prototype, ce = oe.toString, ue = le.hasOwnProperty, Ce = RegExp(
  "^" + ce.call(ue).replace(ie, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function fe(e) {
  if (!re(e) || ne(e))
    return !1;
...
var me = ge, he = ye, de = me;
function pe(e, t) {
  var n = de(e, t);
  return he(n) ? n : void 0;
}
var v1 = pe, ve = v1, _e = function() {
  try {
...
var W9 = $e, xe = J9, ke = W9, Ae = Object.prototype, we = Ae.hasOwnProperty;
function Me(e, t, n) {
  var r = e[t];
  (!(we.call(e, t) && ke(r, n)) || n === void 0 && !(t in e)) && xe(e, t, n);
}
var O0 = Me, Se = Array.isArray, A1 = Se;
function Te(e) {
  return e != null && typeof e == "object";
}
var w1 = Te, Ie = K1, De = w1, Pe = "[object Symbol]";
function Oe(e) {
  return typeof e == "symbol" || De(e) && Ie(e) == Pe;
}
var B0 = Oe, Be = A1, Ee = B0, Ne = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Fe = /^\w*$/;
function Ke(e, t) {
  if (Be(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || Ee(e) ? !0 : Fe.test(e) || !Ne.test(e) || t != null && e in Object(t);
}
var je = Ke, Ze = v1, Qe = Ze(Object, "create"), C0 = Qe, s9 = C0;
function Re() {
...
var Ye = Ue, Ve = C0, He = "__lodash_hash_undefined__", Ge = Object.prototype, Xe = Ge.hasOwnProperty;
function Je(e) {
  var t = this.__data__;
  if (Ve) {
    var n = t[e];
...
var We = Je, qe = C0, e2 = Object.prototype, t2 = e2.hasOwnProperty;
function n2(e) {
  var t = this.__data__;
  return qe ? t[e] !== void 0 : t2.call(t, e);
}
var r2 = n2, a2 = C0, i2 = "__lodash_hash_undefined__";
function s2(e, t) {
  var n = this.__data__;
  return this.size += this.has(e) ? 0 : 1, n[e] = a2 && t === void 0 ? i2 : t, this;
}
var o2 = s2, l2 = ze, c2 = Ye, u2 = We, C2 = r2, f2 = o2;
function M1(e) {
...
M1.prototype.clear = l2;
M1.prototype.delete = c2;
M1.prototype.get = u2;
M1.prototype.has = C2;
M1.prototype.set = f2;
var y2 = M1;
...
var f0 = d2, p2 = f0, v2 = Array.prototype, _2 = v2.splice;
function L2(e) {
...
var I2 = T2, D2 = m2, P2 = b2, O2 = k2, B2 = M2, E2 = I2;
function S1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
S1.prototype.clear = D2;
S1.prototype.delete = P2;
S1.prototype.get = O2;
S1.prototype.has = B2;
S1.prototype.set = E2;
var y0 = S1, N2 = v1, F2 = a1, K2 = N2(F2, "Map"), E0 = K2, o9 = y2, j2 = y0, Z2 = E0;
function Q2() {
...
var i3 = a3, s3 = R2, o3 = X2, l3 = q2, c3 = n3, u3 = i3;
function T1(e) {
  var t = -1, n = e == null ? 0 : e.length;
  for (this.clear(); ++t < n; ) {
    var r = e[t];
...
T1.prototype.clear = s3;
T1.prototype.delete = o3;
T1.prototype.get = l3;
T1.prototype.has = c3;
T1.prototype.set = u3;
var q9 = T1, e5 = q9, C3 = "Expected a function";
function N0(e, t) {
  ...
  return n.cache = new (N0.Cache || e5)(), n;
}
N0.Cache = e5;
var f3 = N0, y3 = f3, g3 = 500;
function m3(e) {
  var t = y3(e, function(r) {
    return n.size === g3 && n.clear(), r;
  }), n = t.cache;
  return t;
}
var h3 = m3, d3 = h3, p3 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, v3 = /\\(\\)?/g, _3 = d3(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(p3, function(n, r, a, s) {
    t.push(a ? s.replace(v3, "$1") : r || n);
  }), t;
}), L3 = _3;
function b3(e, t) {
...
var $3 = b3, l9 = u0, x3 = $3, k3 = A1, A3 = B0, w3 = 1 / 0, c9 = l9 ? l9.prototype : void 0, u9 = c9 ? c9.toString : void 0;
function t5(e) {
  if (typeof e == "string")
    return e;
  if (k3(e))
...
var I3 = T3, D3 = A1, P3 = je, O3 = L3, B3 = I3;
function E3(e, t) {
  return D3(e) ? e : P3(e, t) ? [e] : O3(B3(e));
}
var N3 = E3, F3 = 9007199254740991, K3 = /^(?:0|[1-9]\d*)$/;
function j3(e, t) {
  var n = typeof e;
  return t = t ?? F3, !!t && (n == "number" || n != "symbol" && K3.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
var n5 = j3, Z3 = B0, Q3 = 1 / 0;
function R3(e) {
...
var z3 = R3, U3 = O0, Y3 = N3, V3 = n5, C9 = k1, H3 = z3;
function G3(e, t, n, r) {
  if (!C9(e))
    return e;
  t = Y3(t, e);
  for (var a = -1, s = t.length, o = s - 1, i = e; i != null && ++a < s; ) {
    ...
    if (a != o) {
      var f = i[l];
      C = r ? r(f, l, i) : void 0, C === void 0 && (C = C9(f) ? f : V3(t[a + 1]) ? [] : {});
    }
    U3(i, l, C), i = i[l];
  }
  return e;
...
var l8 = o8, c8 = y0, u8 = E0, C8 = q9, f8 = 200;
function y8(e, t) {
  var n = this.__data__;
  if (n instanceof c8) {
    var r = n.__data__;
    ...
    n = this.__data__ = new C8(r);
  }
  return n.set(e, t), this.size = n.size, this;
}
var g8 = y8, m8 = y0, h8 = n8, d8 = a8, p8 = s8, v8 = l8, _8 = g8;
function I1(e) {
  var t = this.__data__ = new m8(e);
  this.size = t.size;
}
I1.prototype.clear = h8;
I1.prototype.delete = d8;
I1.prototype.get = p8;
I1.prototype.has = v8;
I1.prototype.set = _8;
var L8 = I1;
...
var $8 = b8, x8 = O0, k8 = J9;
function A8(e, t, n, r) {
  var a = !n;
  n || (n = {});
  for (var s = -1, o = t.length; ++s < o; ) {
    var i = t[s], l = r ? r(n[i], e[i], i, n, e) : void 0;
    l === void 0 && (l = e[i]), a ? k8(n, i, l) : x8(n, i, l);
  }
  return n;
}
var m0 = A8;
...
var M8 = w8, S8 = K1, T8 = w1, I8 = "[object Arguments]";
function D8(e) {
  return T8(e) && S8(e) == I8;
}
var P8 = D8, f9 = P8, O8 = w1, r5 = Object.prototype, B8 = r5.hasOwnProperty, E8 = r5.propertyIsEnumerable, N8 = f9(function() {
  return arguments;
}()) ? f9 : function(e) {
  return O8(e) && B8.call(e, "callee") && !E8.call(e, "callee");
}, F8 = N8, a0 = { exports: {} };
function K8() {
  return !1;
}
...
a0.exports;
(function(e, t) {
  var n = a1, r = j8, a = t && !t.nodeType && t, s = a && !0 && e && !e.nodeType && e, o = s && s.exports === a, i = o ? n.Buffer : void 0, l = i ? i.isBuffer : void 0, C = l || r;
  e.exports = C;
})(a0, a0.exports);
var a5 = a0.exports, Z8 = 9007199254740991;
function Q8(e) {
  return typeof e == "number" && e > -1 && e % 1 == 0 && e <= Z8;
}
var i5 = Q8, R8 = K1, z8 = i5, U8 = w1, Y8 = "[object Arguments]", V8 = "[object Array]", H8 = "[object Boolean]", G8 = "[object Date]", X8 = "[object Error]", J8 = "[object Function]", W8 = "[object Map]", q8 = "[object Number]", e7 = "[object Object]", t7 = "[object RegExp]", n7 = "[object Set]", r7 = "[object String]", a7 = "[object WeakMap]", i7 = "[object ArrayBuffer]", s7 = "[object DataView]", o7 = "[object Float32Array]", l7 = "[object Float64Array]", c7 = "[object Int8Array]", u7 = "[object Int16Array]", C7 = "[object Int32Array]", f7 = "[object Uint8Array]", y7 = "[object Uint8ClampedArray]", g7 = "[object Uint16Array]", m7 = "[object Uint32Array]", E = {};
E[o7] = E[l7] = E[c7] = E[u7] = E[C7] = E[f7] = E[y7] = E[g7] = E[m7] = !0;
E[Y8] = E[V8] = E[i7] = E[H8] = E[s7] = E[G8] = E[X8] = E[J8] = E[W8] = E[q8] = E[e7] = E[t7] = E[n7] = E[r7] = E[a7] = !1;
function h7(e) {
  return U8(e) && z8(e.length) && !!E[R8(e)];
}
var d7 = h7;
function p7(e) {
  return function(t) {
...
var F0 = p7, i0 = { exports: {} };
i0.exports;
(function(e, t) {
  var n = V9, r = t && !t.nodeType && t, a = r && !0 && e && !e.nodeType && e, s = a && a.exports === r, o = s && n.process, i = function() {
    try {
...
var K0 = i0.exports, v7 = d7, _7 = F0, y9 = K0, g9 = y9 && y9.isTypedArray, L7 = g9 ? _7(g9) : v7, b7 = L7, $7 = M8, x7 = F8, k7 = A1, A7 = a5, w7 = n5, M7 = b7, S7 = Object.prototype, T7 = S7.hasOwnProperty;
function I7(e, t) {
  var n = k7(e), r = !n && x7(e), a = !n && !r && A7(e), s = !n && !r && !a && M7(e), o = n || r || a || s, i = o ? $7(e.length, String) : [], l = i.length;
  for (var C in e)
    (t || T7.call(e, C)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var o5 = O7, B7 = o5, E7 = B7(Object.keys, Object), N7 = E7, F7 = j0, K7 = N7, j7 = Object.prototype, Z7 = j7.hasOwnProperty;
function Q7(e) {
  if (!F7(e))
    return K7(e);
  var t = [];
...
var R7 = Q7, z7 = G9, U7 = i5;
function Y7(e) {
  return e != null && U7(e.length) && !z7(e);
}
var l5 = Y7, V7 = s5, H7 = R7, G7 = l5;
function X7(e) {
  return G7(e) ? V7(e) : H7(e);
}
var Z0 = X7, J7 = m0, W7 = Z0;
function q7(e, t) {
...
var nt = tt, rt = k1, at = j0, it = nt, st = Object.prototype, ot = st.hasOwnProperty;
function lt(e) {
  if (!rt(e))
    return it(e);
  var t = at(e), n = [];
...
var ct = lt, ut = s5, Ct = ct, ft = l5;
function yt(e) {
  return ft(e) ? ut(e, !0) : Ct(e);
}
var Q0 = yt, gt = m0, mt = Q0;
function ht(e, t) {
  return e && gt(t, mt(t), e);
}
var dt = ht, s0 = { exports: {} };
s0.exports;
(function(e, t) {
  var n = a1, r = t && !t.nodeType && t, a = r && !0 && e && !e.nodeType && e, s = a && a.exports === r, o = s ? n.Buffer : void 0, i = o ? o.allocUnsafe : void 0;
  function l(C, f) {
    if (f)
      return C.slice();
...
var c5 = $t, xt = bt, kt = c5, At = Object.prototype, wt = At.propertyIsEnumerable, m9 = Object.getOwnPropertySymbols, Mt = m9 ? function(e) {
  return e == null ? [] : (e = Object(e), xt(m9(e), function(t) {
    return wt.call(e, t);
  }));
} : kt, R0 = Mt, St = m0, Tt = R0;
function It(e, t) {
  return St(e, Tt(e), t);
}
var Dt = It;
...
var u5 = Pt, Ot = o5, Bt = Ot(Object.getPrototypeOf, Object), C5 = Bt, Et = u5, Nt = C5, Ft = R0, Kt = c5, jt = Object.getOwnPropertySymbols, Zt = jt ? function(e) {
  for (var t = []; e; )
    Et(t, Ft(e)), e = Nt(e);
  return t;
} : Kt, f5 = Zt, Qt = m0, Rt = f5;
function zt(e, t) {
  return Qt(e, Rt(e), t);
}
var Ut = zt, Yt = u5, Vt = A1;
function Ht(e, t, n) {
  var r = t(e);
  return Vt(e) ? r : Yt(r, n(e));
}
var y5 = Ht, Gt = y5, Xt = R0, Jt = Z0;
function Wt(e) {
  return Gt(e, Jt, Xt);
}
var qt = Wt, e4 = y5, t4 = f5, n4 = Q0;
function r4(e) {
  return e4(e, n4, t4);
}
var a4 = r4, i4 = v1, s4 = a1, o4 = i4(s4, "DataView"), l4 = o4, c4 = v1, u4 = a1, C4 = c4(u4, "Promise"), f4 = C4, y4 = v1, g4 = a1, m4 = y4(g4, "Set"), h4 = m4, d4 = v1, p4 = a1, v4 = d4(p4, "WeakMap"), _4 = v4, A0 = l4, w0 = E0, M0 = f4, S0 = h4, T0 = _4, g5 = K1, D1 = X9, h9 = "[object Map]", L4 = "[object Object]", d9 = "[object Promise]", p9 = "[object Set]", v9 = "[object WeakMap]", _9 = "[object DataView]", b4 = D1(A0), $4 = D1(w0), x4 = D1(M0), k4 = D1(S0), A4 = D1(T0), d1 = g5;
(A0 && d1(new A0(new ArrayBuffer(1))) != _9 || w0 && d1(new w0()) != h9 || M0 && d1(M0.resolve()) != d9 || S0 && d1(new S0()) != p9 || T0 && d1(new T0()) != v9) && (d1 = function(e) {
  var t = g5(e), n = t == L4 ? e.constructor : void 0, r = n ? D1(n) : "";
  if (r)
    switch (r) {
      case b4:
        return _9;
...
var z0 = d1, w4 = Object.prototype, M4 = w4.hasOwnProperty;
function S4(e) {
  var t = e.length, n = new e.constructor(t);
  return t && typeof e[0] == "string" && M4.call(e, "index") && (n.index = e.index, n.input = e.input), n;
}
var T4 = S4, I4 = a1, D4 = I4.Uint8Array, P4 = D4, L9 = P4;
function O4(e) {
...
var j4 = K4, b9 = u0, $9 = b9 ? b9.prototype : void 0, x9 = $9 ? $9.valueOf : void 0;
function Z4(e) {
  return x9 ? Object(x9.call(e)) : {};
}
var Q4 = Z4, R4 = U0;
function z4(e, t) {
  var n = t ? R4(e.buffer) : e.buffer;
  return new e.constructor(n, e.byteOffset, e.length);
}
var U4 = z4, Y4 = U0, V4 = N4, H4 = j4, G4 = Q4, X4 = U4, J4 = "[object Boolean]", W4 = "[object Date]", q4 = "[object Map]", en = "[object Number]", tn = "[object RegExp]", nn = "[object Set]", rn = "[object String]", an = "[object Symbol]", sn = "[object ArrayBuffer]", on = "[object DataView]", ln = "[object Float32Array]", cn = "[object Float64Array]", un = "[object Int8Array]", Cn = "[object Int16Array]", fn = "[object Int32Array]", yn = "[object Uint8Array]", gn = "[object Uint8ClampedArray]", mn = "[object Uint16Array]", hn = "[object Uint32Array]";
function dn(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case sn:
...
var pn = dn, vn = k1, k9 = Object.create, _n = function() {
  function e() {
  }
  return function(t) {
    if (!vn(t))
...
}(), Ln = _n, bn = Ln, $n = C5, xn = j0;
function kn(e) {
  return typeof e.constructor == "function" && !xn(e) ? bn($n(e)) : {};
}
var An = kn, wn = z0, Mn = w1, Sn = "[object Map]";
function Tn(e) {
  return Mn(e) && wn(e) == Sn;
}
var In = Tn, Dn = In, Pn = F0, A9 = K0, w9 = A9 && A9.isMap, On = w9 ? Pn(w9) : Dn, Bn = On, En = z0, Nn = w1, Fn = "[object Set]";
function Kn(e) {
  return Nn(e) && En(e) == Fn;
}
var jn = Kn, Zn = jn, Qn = F0, M9 = K0, S9 = M9 && M9.isSet, Rn = S9 ? Qn(S9) : Zn, zn = Rn, Un = L8, Yn = $8, Vn = O0, Hn = et, Gn = dt, Xn = pt, Jn = _t, Wn = Dt, qn = Ut, er = qt, tr = a4, nr = z0, rr = T4, ar = pn, ir = An, sr = A1, or = a5, lr = Bn, cr = k1, ur = zn, Cr = Z0, fr = Q0, yr = 1, gr = 2, mr = 4, m5 = "[object Arguments]", hr = "[object Array]", dr = "[object Boolean]", pr = "[object Date]", vr = "[object Error]", h5 = "[object Function]", _r = "[object GeneratorFunction]", Lr = "[object Map]", br = "[object Number]", d5 = "[object Object]", $r = "[object RegExp]", xr = "[object Set]", kr = "[object String]", Ar = "[object Symbol]", wr = "[object WeakMap]", Mr = "[object ArrayBuffer]", Sr = "[object DataView]", Tr = "[object Float32Array]", Ir = "[object Float64Array]", Dr = "[object Int8Array]", Pr = "[object Int16Array]", Or = "[object Int32Array]", Br = "[object Uint8Array]", Er = "[object Uint8ClampedArray]", Nr = "[object Uint16Array]", Fr = "[object Uint32Array]", O = {};
O[m5] = O[hr] = O[Mr] = O[Sr] = O[dr] = O[pr] = O[Tr] = O[Ir] = O[Dr] = O[Pr] = O[Or] = O[Lr] = O[br] = O[d5] = O[$r] = O[xr] = O[kr] = O[Ar] = O[Br] = O[Er] = O[Nr] = O[Fr] = !0;
O[vr] = O[h5] = O[wr] = !1;
function W1(e, t, n, r, a, s) {
  var o, i = t & yr, l = t & gr, C = t & mr;
  ...
  if (f) {
    ...
    var c = nr(e), _ = c == h5 || c == _r;
    if (or(e))
      return Xn(e, i);
    if (c == d5 || c == m5 || _ && !a) {
      if (o = l || _ ? {} : ir(e), !i)
        return l ? qn(e, Gn(o, e)) : Wn(e, Hn(o, e));
    } else {
      if (!O[c])
        return a ? e : {};
      o = ar(e, c, i);
  ...
  if (b)
    return b;
  s.set(e, o), ur(e) ? e.forEach(function(K) {
    o.add(W1(K, t, n, K, e, s));
  }) : lr(e) && e.forEach(function(K, w) {
    o.set(w, W1(K, t, n, w, e, s));
  });
  var I = C ? l ? tr : er : l ? fr : Cr, A = f ? void 0 : I(e);
  return Yn(A || e, function(K, w) {
    A && (w = K, K = e[w]), Vn(o, w, W1(K, t, n, w, e, s));
  }), o;
}
var Kr = W1, jr = Kr, Zr = 1, Qr = 4;
function Rr(e) {
  return jr(e, Zr | Qr);
}
var zr = Rr;
const Ur = /* @__PURE__ */ Y9(zr);
var Yr = /* @__PURE__ */ m("<button>");
const Vr = (e) => (() => {
  var t = Yr();
  return C1(t, "click", e.onClick, !0), d(t, () => e.children), R((n) => {
    var r = e.style, a = `klinecharts-pro-button ${e.type ?? "confirm"} ${e.class ?? ""}`;
    return n.e = x1(t, r, n.e), a !== n.t && p1(t, n.t = a), n;
  }, {
    e: void 0,
    t: void 0
  }), t;
...
r1(["click"]);
var Hr = /* @__PURE__ */ m('<svg viewBox="0 0 1024 1024"class=icon><path d="M810.666667 128H213.333333c-46.933333 0-85.333333 38.4-85.333333 85.333333v597.333334c0 46.933333 38.4 85.333333 85.333333 85.333333h597.333334c46.933333 0 85.333333-38.4 85.333333-85.333333V213.333333c0-46.933333-38.4-85.333333-85.333333-85.333333z m-353.706667 567.04a42.496 42.496 0 0 1-60.16 0L243.626667 541.866667c-8.106667-8.106667-12.373333-18.773333-12.373334-29.866667s4.693333-22.186667 12.373334-29.866667a42.496 42.496 0 0 1 60.16 0L426.666667 604.586667l293.546666-293.546667a42.496 42.496 0 1 1 60.16 60.16l-323.413333 323.84z">'), Gr = /* @__PURE__ */ m('<svg viewBox="0 0 1024 1024"class=icon><path d="M245.333333 128h533.333334A117.333333 117.333333 0 0 1 896 245.333333v533.333334A117.333333 117.333333 0 0 1 778.666667 896H245.333333A117.333333 117.333333 0 0 1 128 778.666667V245.333333A117.333333 117.333333 0 0 1 245.333333 128z m0 64c-29.44 0-53.333333 23.893333-53.333333 53.333333v533.333334c0 29.44 23.893333 53.333333 53.333333 53.333333h533.333334c29.44 0 53.333333-23.893333 53.333333-53.333333V245.333333c0-29.44-23.893333-53.333333-53.333333-53.333333H245.333333z">'), Xr = /* @__PURE__ */ m("<div>"), Jr = /* @__PURE__ */ m("<span class=label>");
const Wr = () => Hr(), qr = () => Gr(), T9 = (e) => {
  ...
  return s1(() => {
    ...
    return r.$$click = (a) => {
      ...
      return a.e = x1(r, s, a.e), o !== a.t && p1(r, a.t = o), a;
    }, {
      e: void 0,
      t: void 0
    }), r;
...
const o0 = (e) => (() => {
  ...
  return d(t, h(Y, {
    ...
    get when() {
      var n;
      return H(() => !e.loading && !e.children)() && !((n = e.dataSource) != null && n.length);
    },
    get children() {
      return h(na, {});
    }
    ...
    get children() {
      ...
      return (n = e.dataSource) == null ? void 0 : n.map((r) => {
        var a;
        return ((a = e.renderItem) == null ? void 0 : a.call(e, r)) ?? aa();
      });
    }
  }), null), R((n) => {
...
var ia = /* @__PURE__ */ m('<div class=klinecharts-pro-modal><div class=inner><div class=title-container><svg class=close-icon viewBox="0 0 1024 1024"><path d="M934.184927 199.723787 622.457206 511.452531l311.727721 311.703161c14.334473 14.229073 23.069415 33.951253 23.069415 55.743582 0 43.430138-35.178197 78.660524-78.735226 78.660524-21.664416 0-41.361013-8.865925-55.642275-23.069415L511.149121 622.838388 199.420377 934.490384c-14.204513 14.20349-33.901111 23.069415-55.642275 23.069415-43.482327 0-78.737272-35.230386-78.737272-78.660524 0-21.792329 8.864902-41.513486 23.094998-55.743582l311.677579-311.703161L88.135828 199.723787c-14.230096-14.255679-23.094998-33.92567-23.094998-55.642275 0-43.430138 35.254945-78.762855 78.737272-78.762855 21.741163 0 41.437761 8.813736 55.642275 23.069415l311.727721 311.727721L822.876842 88.389096c14.281261-14.255679 33.977859-23.069415 55.642275-23.069415 43.557028 0 78.735226 35.332716 78.735226 78.762855C957.254342 165.798117 948.5194 185.468109 934.184927 199.723787"></path></svg></div><div class=content-container>'), sa = /* @__PURE__ */ m("<div class=button-container>");
const P1 = (e) => (() => {
  var t = ia(), n = t.firstChild, r = n.firstChild, a = r.firstChild, s = r.nextSibling;
  return d(r, () => e.title, a), C1(a, "click", e.onClose, !0), d(s, () => e.children), d(n, (() => {
    var o = H(() => !!(e.buttons && e.buttons.length > 0));
    return () => o() && (() => {
      var i = sa();
      return d(i, () => e.buttons.map((l) => h(Vr, U9(l, {
        get children() {
          return l.children;
        }
      })))), i;
    })();
  })(), null), R((o) => p6(n, "width", `${e.width ?? 400}px`)), t;
})();
r1(["click"]);
var oa = /* @__PURE__ */ m("<div tabindex=0><div class=selector-container><span class=value></span><i class=arrow>"), la = /* @__PURE__ */ m("<div class=drop-down-container><ul>"), ca = /* @__PURE__ */ m("<li>");
const v5 = (e) => {
  const [t, n] = L(!1);
  return (() => {
    var r = oa(), a = r.firstChild, s = a.firstChild;
    return r.addEventListener("blur", (o) => {
      n(!1);
    }), r.$$click = (o) => {
      n((i) => !i);
    }, d(s, () => e.value), d(r, (() => {
      var o = H(() => !!(e.dataSource && e.dataSource.length > 0));
      return () => o() && (() => {
        var i = la(), l = i.firstChild;
        return d(l, () => e.dataSource.map((C) => {
          ...
          return (() => {
            ...
            return _.$$click = (b) => {
              var I;
              b.stopPropagation(), e.value !== c && ((I = e.onSelected) == null || I.call(e, C)), n(!1);
            }, d(_, c), _;
          })();
        })), i;
      })();
      ...
      return o.e = x1(r, i, o.e), l !== o.t && p1(r, o.t = l), o;
    }, {
      e: void 0,
      t: void 0
    }), r;
...
r1(["click"]);
var ua = /* @__PURE__ */ m("<span class=prefix>"), Ca = /* @__PURE__ */ m("<span class=suffix>"), fa = /* @__PURE__ */ m("<div><input class=value>");
const _5 = (e) => {
  const t = U9({
  ...
  return (() => {
    ...
    return s.$$click = () => {
      ...
      return i.e = x1(s, l, i.e), C !== i.t && p1(s, i.t = C), f !== i.a && J(s, "data-status", i.a = f), c !== i.o && J(o, "placeholder", i.o = c), i;
    }, {
      e: void 0,
      t: void 0,
      a: void 0,
...
r1(["click"]);
var ya = /* @__PURE__ */ m("<div><i class=thumb>");
const ga = (e) => (() => {
  var t = ya();
  return t.$$click = (n) => {
...
r1(["click"]);
const ma = "指标", ha = "主图指标", da = "副图指标", pa = "设置", va = "时区", _a = "截屏", La = "全屏", ba = "退出全屏", $a = "保存", xa = "确定", ka = "取消", Aa = "MA(移动平均线)", wa = "EMA(指数平滑移动平均线)", Ma = "SMA", Sa = "BOLL(布林线)", Ta = "BBI(多空指数)", Ia = "SAR(停损点指向指标)", Da = "VOL(成交量)", Pa = "MACD(指数平滑异同移动平均线)", Oa = "KDJ(随机指标)", Ba = "RSI(相对强弱指标)", Ea = "BIAS(乖离率)", Na = "BRAR(情绪指标)", Fa = "CCI(顺势指标)", Ka = "DMI(动向指标)", ja = "CR(能量指标)", Za = "PSY(心理线)", Qa = "DMA(平行线差指标)", Ra = "TRIX(三重指数平滑平均线)", za = "OBV(能量潮指标)", Ua = "VR(成交量变异率)", Ya = "WR(威廉指标)", Va = "MTM(动量指标)", Ha = "EMV(简易波动指标)", Ga = "ROC(变动率指标)", Xa = "PVT(价量趋势指标)", Ja = "AO(动量震荡指标)", Wa = "世界统一时间", qa = "(UTC-10) 檀香山", ei = "(UTC-8) 朱诺", ti = "(UTC-7) 洛杉矶", ni = "(UTC-5) 芝加哥", ri = "(UTC-4) 多伦多", ai = "(UTC-3) 圣保罗", ii = "(UTC+1) 伦敦", si = "(UTC+2) 柏林", oi = "(UTC+3) 巴林", li = "(UTC+4) 迪拜", ci = "(UTC+5) 阿什哈巴德", ui = "(UTC+6) 阿拉木图", Ci = "(UTC+7) 曼谷", fi = "(UTC+8) 上海", yi = "(UTC+9) 东京", gi = "(UTC+10) 悉尼", mi = "(UTC+12) 诺福克岛", hi = "水平直线", di = "水平射线", pi = "水平线段", vi = "垂直直线", _i = "垂直射线", Li = "垂直线段", bi = "直线", $i = "射线", xi = "线段", ki = "箭头", Ai = "价格线", wi = "价格通道线", Mi = "平行直线", Si = "斐波那契回调直线", Ti = "斐波那契回调线段", Ii = "斐波那契圆环", Di = "斐波那契螺旋", Pi = "斐波那契速度阻力扇", Oi = "斐波那契趋势扩展", Bi = "江恩箱", Ei = "矩形", Ni = "平行四边形", Fi = "圆", Ki = "三角形", ji = "三浪", Zi = "五浪", Qi = "八浪", Ri = "任意浪", zi = "ABCD形态", Ui = "XABCD形态", Yi = "弱磁模式", Vi = "强磁模式", Hi = "商品搜索", Gi = "商品代码", Xi = "参数1", Ji = "参数2", Wi = "参数3", qi = "参数4", es = "参数5", ts = "周期", ns = "标准差", rs = "蜡烛图类型", as = "全实心", is = "全空心", ss = "涨空心", os = "跌空心", ls = "OHLC", cs = "面积图", us = "最新价显示", Cs = "最高价显示", fs = "最低价显示", ys = "指标最新值显示", gs = "价格轴类型", ms = "线性轴", hs = "百分比轴", ds = "对数轴", ps = "倒置坐标", vs = "网格线显示", _s = "恢复默认", Ls = {
  indicator: ma,
  main_indicator: ha,
  sub_indicator: da,
  setting: pa,
  ...
  sydney: gi,
  norfolk: mi,
  horizontal_straight_line: hi,
  horizontal_ray_line: di,
  ...
  fibonacci_circle: Ii,
  fibonacci_spiral: Di,
  fibonacci_speed_resistance_fan: Pi,
  ...
  grid_show: vs,
  restore_default: _s
}, bs = "Indicator", $s = "Main Indicator", xs = "Sub Indicator", ks = "Setting", As = "Timezone", ws = "Screenshot", Ms = "Full Screen", Ss = "Exit", Ts = "Save", Is = "Confirm", Ds = "Cancel", Ps = "MA(Moving Average)", Os = "EMA(Exponential Moving Average)", Bs = "SMA", Es = "BOLL(Bolinger Bands)", Ns = "BBI(Bull And Bearlndex)", Fs = "SAR(Stop and Reverse)", Ks = "VOL(Volume)", js = "MACD(Moving Average Convergence / Divergence)", Zs = "KDJ(KDJ Index)", Qs = "RSI(Relative Strength Index)", Rs = "BIAS(Bias Ratio)", zs = "BRAR(情绪指标)", Us = "CCI(Commodity Channel Index)", Ys = "DMI(Directional Movement Index)", Vs = "CR(能量指标)", Hs = "PSY(Psychological Line)", Gs = "DMA(Different of Moving Average)", Xs = "TRIX(Triple Exponentially Smoothed Moving Average)", Js = "OBV(On Balance Volume)", Ws = "VR(Volatility Volume Ratio)", qs = "WR(Williams %R)", eo = "MTM(Momentum Index)", to = "EMV(Ease of Movement Value)", no = "ROC(Price Rate of Change)", ro = "PVT(Price and Volume Trend)", ao = "AO(Awesome Oscillator)", io = "UTC", so = "(UTC-10) Honolulu", oo = "(UTC-8) Juneau", lo = "(UTC-7) Los Angeles", co = "(UTC-5) Chicago", uo = "(UTC-4) Toronto", Co = "(UTC-3) Sao Paulo", fo = "(UTC+1) London", yo = "(UTC+2) Berlin", go = "(UTC+3) Bahrain", mo = "(UTC+4) Dubai", ho = "(UTC+5) Ashkhabad", po = "(UTC+6) Almaty", vo = "(UTC+7) Bangkok", _o = "(UTC+8) Shanghai", Lo = "(UTC+9) Tokyo", bo = "(UTC+10) Sydney", $o = "(UTC+12) Norfolk", xo = "Horizontal Line", ko = "Horizontal Ray", Ao = "Horizontal Segment", wo = "Vertical Line", Mo = "Vertical Ray", So = "Vertical Segment", To = "Trend Line", Io = "Ray", Do = "Segment", Po = "Arrow", Oo = "Price Line", Bo = "Price Channel Line", Eo = "Parallel Line", No = "Fibonacci Line", Fo = "Fibonacci Segment", Ko = "Fibonacci Circle", jo = "Fibonacci Spiral", Zo = "Fibonacci Sector", Qo = "Fibonacci Extension", Ro = "Gann Box", zo = "Rect", Uo = "Parallelogram", Yo = "Circle", Vo = "Triangle", Ho = "Three Waves", Go = "Five Waves", Xo = "Eight Waves", Jo = "Any Waves", Wo = "ABCD Pattern", qo = "XABCD Pattern", el = "Weak Magnet", tl = "Strong Magnet", nl = "Symbol Search", rl = "Symbol Code", al = "Parameter 1", il = "Parameter 2", sl = "Parameter 3", ol = "Parameter 4", ll = "Parameter 5", cl = "Period", ul = "Standard Deviation", Cl = "Candle Type", fl = "Candle Solid", yl = "Candle Stroke", gl = "Candle Up Stroke", ml = "Candle Down Stroke", hl = "OHLC", dl = "Area", pl = "Show Last Price", vl = "Show Highest Price", _l = "Show Lowest Price", Ll = "Show indicator's last value", bl = "Price Axis Type", $l = "Normal", xl = "Percentage", kl = "Log", Al = "Reverse Coordinate", wl = "Show Grids", Ml = "Restore Defaults", Sl = {
  indicator: bs,
  main_indicator: $s,
  sub_indicator: xs,
  setting: ks,
  ...
  params_5: ll,
  period: cl,
  standard_deviation: ul,
  candle_type: Cl,
  candle_solid: fl,
  candle_stroke: yl,
  candle_up_stroke: gl,
  candle_down_stroke: ml,
  ohlc: hl,
  area: dl,
  last_price_show: pl,
  high_price_show: vl,
...
const Bl = (e) => {
  ...
  return j9(() => {
    ...
    var s = Dl(), o = s.firstChild, i = o.firstChild, l = o.nextSibling, C = l.firstChild, f = C.nextSibling, c = l.nextSibling, _ = c.firstChild, b = _.nextSibling, I = c.nextSibling, A = I.firstChild, K = A.nextSibling, w = I.nextSibling, Z = w.firstChild, N = Z.nextSibling, x = w.nextSibling;
    return P0(($) => {
      t = $;
    }, s), C1(i, "click", e.onMenuClick, !0), d(s, h(Y, {
      get when() {
        return e.symbol;
      },
      get children() {
        var $ = Il(), B = $.firstChild;
        return C1($, "click", e.onSymbolClick, !0), d($, h(Y, {
          get when() {
            return e.symbol.logo;
          },
          get children() {
            var G = Tl();
            return R(() => J(G, "src", e.symbol.logo)), G;
          }
        }), B), d(B, () => e.symbol.shortName ?? e.symbol.name ?? e.symbol.ticker), $;
      }
    }), l), d(s, () => e.periods.map(($) => (() => {
      var B = L0();
      return B.$$click = () => {
        e.onPeriodChange($);
      }, d(B, () => $.text), R(() => p1(B, `item period ${$.text === e.period.text ? "selected" : ""}`)), B;
    })()), l), C1(l, "click", e.onIndicatorClick, !0), d(f, () => u("indicator", e.locale)), C1(c, "click", e.onTimezoneClick, !0), d(b, () => u("timezone", e.locale)), C1(I, "click", e.onSettingClick, !0), d(K, () => u("setting", e.locale)), C1(w, "click", e.onScreenshotClick, !0), d(N, () => u("screenshot", e.locale)), x.$$click = () => {
      if (n())
        ...
        const $ = t == null ? void 0 : t.parentElement;
        $ && ($.requestFullscreen ?? $.webkitRequestFullscreen ?? $.mozRequestFullScreen ?? $.msRequestFullscreen).call($);
      }
    }, d(x, (() => {
      var $ = H(() => !!n());
      return () => $() ? [Pl(), (() => {
        var B = L0();
        return d(B, () => u("exit_full_screen", e.locale)), B;
      })()] : [Ol(), (() => {
        var B = L0();
        return d(B, () => u("full_screen", e.locale)), B;
      })()];
    })()), R(() => J(i, "class", e.spread ? "" : "rotate")), s;
  })();
};
r1(["click"]);
var El = /* @__PURE__ */ m('<svg class=icon-overlay viewBox="0 0 22 22"><path d=M12.41465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L12.41465,12C12.20873,12.5826,11.65311,13,11,13C10.34689,13,9.79127,12.5826,9.58535,12L3.5,12C3.223857,12,3,11.77614,3,11.5C3,11.22386,3.223857,11,3.5,11L9.58535,11C9.79127,10.417404,10.34689,10,11,10C11.65311,10,12.20873,10.417404,12.41465,11Z stroke-opacity=0 stroke=none>');
const Nl = () => El();
var Fl = /* @__PURE__ */ m('<svg class=icon-overlay viewBox="0 0 22 22"><path d=M6.91465,11L11.08535,11C11.29127,10.417404,11.84689,10,12.5,10C13.15311,10,13.70873,10.417404,13.91465,11L18.5,11C18.7761,11,19,11.22386,19,11.5C19,11.77614,18.7761,12,18.5,12L13.91465,12C13.70873,12.5826,13.15311,13,12.5,13C11.84689,13,11.29127,12.5826,11.08535,12L6.91465,12C6.70873,12.5826,6.15311,13,5.5,13C4.671573,13,4,12.32843,4,11.5C4,10.671573,4.671573,10,5.5,10C6.15311,10,6.70873,10.417404,6.91465,11Z stroke-opacity=0 stroke=none>');
const Kl = () => Fl();
var jl = /* @__PURE__ */ m('<svg class=icon-overlay viewBox="0 0 22 22"><path d=M6.91465,12.5C6.70873,13.0826,6.15311,13.5,5.5,13.5C4.671573,13.5,4,12.82843,4,12C4,11.171573,4.671573,10.5,5.5,10.5C6.15311,10.5,6.70873,10.917404,6.91465,11.5L16.0853,11.5C16.2913,10.917404,16.846899999999998,10.5,17.5,10.5C18.328400000000002,10.5,19,11.171573,19,12C19,12.82843,18.328400000000002,13.5,17.5,13.5C16.846899999999998,13.5,16.2913,13.0826,16.0853,12.5L6.91465,12.5Z stroke-opacity=0 stroke=none>');
const Zl = () => jl();
var Ql = /* @__PURE__ */ m('<svg class=icon-overlay viewBox="0 0 22 22"><path d=M11,12.41465L11,18.5C11,18.7761,11.22386,19,11.5,19C11.77614,19,12,18.7761,12,18.5L12,12.41465C12.5826,12.20873,13,11.65311,13,11C13,10.34689,12.5826,9.79127,12,9.58535L12,3.5C12,3.223857,11.77614,3,11.5,3C11.22386,3,11,3.223857,11,3.5L11,9.58535C10.417404,9.79127,10,10.34689,10,11C10,11.65311,10.417404,12.20873,11,12.41465Z stroke-opacity=0 stroke=none>');
const Rl = () => Ql();
var zl = /* @__PURE__ */ m('<svg class=icon-overlay viewBox="0 0 22 22"><path d=M11.66558837890625,19C10.83716137890625,19,10.16558837890625,18.328400000000002,10.16558837890625,17.5C10.16558837890625,16.846899999999998,10.58298437890625,16.2913,11.16557337890625,16.0854L11.16557337890625,11.91464C10.58298437890625,11.70872,10.16558837890625,11.1531,10.16558837890625,10.5C10.16558837890625,9.8469,10.58298437890625,9.29128,11.16557337890625,9.08536L11.16557337890625,4.5C11.16557337890625,4.223857,11.38942837890625,4,11.66556837890625,4C11.94171837890625,4,12.16556837890625,4.223857,12.16556837890625,4.5L12.16556837890625,9.08535C12.74817837890625,9.291260000000001,13.16558837890625,9.846879999999999,13.16558837890625,10.5C13.16558837890625,11.153120000000001,12.74817837890625,11.708739999999999,12.16556837890625,11.91465L12.16556837890625,16.0854C12.74817837890625,16.2913,13.16558837890625,16.846899999999998,13.16558837890625,17.5C13.16558837890625,18.328400000000002,12.49401837890625,19,11.66558837890625,19Z stroke-opacity=0 stroke=none>');
const Ul = () => zl();
...
const tu = () => eu(), nu = {
  ...
  priceLine: rc,
  priceChannelLine: ic,
  parallelStraightLine: oc,
  fibonacciLine: cc,
  fibonacciSegment: Cc,
  fibonacciCircle: yc,
  fibonacciSpiral: mc,
  fibonacciSpeedResistanceFan: dc,
  fibonacciExtension: vc,
  gannBox: Lc,
  circle: $c,
  triangle: kc,
  rect: wc,
...
const W = (e) => nu[e.name](e.class);
var cu = /* @__PURE__ */ m('<div class=klinecharts-pro-drawing-bar><span class=split-line></span><div class=item tabindex=0><span style=width:32px;height:32px></span><div class=icon-arrow><svg viewBox="0 0 4 6"><path d=M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z stroke=none stroke-opacity=0></path></svg></div></div><div class=item><span style=width:32px;height:32px></span></div><div class=item><span style=width:32px;height:32px></span></div><span class=split-line></span><div class=item><span style=width:32px;height:32px>'), uu = /* @__PURE__ */ m('<div class=item tabindex=0><span style=width:32px;height:32px></span><div class=icon-arrow><svg viewBox="0 0 4 6"><path d=M1.07298,0.159458C0.827521,-0.0531526,0.429553,-0.0531526,0.184094,0.159458C-0.0613648,0.372068,-0.0613648,0.716778,0.184094,0.929388L2.61275,3.03303L0.260362,5.07061C0.0149035,5.28322,0.0149035,5.62793,0.260362,5.84054C0.505822,6.05315,0.903789,6.05315,1.14925,5.84054L3.81591,3.53075C4.01812,3.3556,4.05374,3.0908,3.92279,2.88406C3.93219,2.73496,3.87113,2.58315,3.73964,2.46925L1.07298,0.159458Z stroke=none stroke-opacity=0>'), I9 = /* @__PURE__ */ m("<li><span style=padding-left:8px>");
const D9 = "drawing_tools", Cu = (e) => {
  const [t, n] = L("horizontalStraightLine"), [r, a] = L("priceChannelLine"), [s, o] = L("circle"), [i, l] = L("fibonacciLine"), [C, f] = L("xabcd"), [c, _] = L("weak_magnet"), [b, I] = L("normal"), [A, K] = L(!1), [w, Z] = L(!0), [N, x] = L(""), $ = n1(() => [{
    key: "singleLine",
    icon: t(),
    list: ru(e.locale),
    setter: n
  ...
  return (() => {
    var G = cu(), i1 = G.firstChild, M = i1.nextSibling, D = M.firstChild, U = D.nextSibling, Q = U.firstChild, t1 = M.nextSibling, O1 = t1.firstChild, j1 = t1.nextSibling, Z1 = j1.firstChild, Q1 = j1.nextSibling, R1 = Q1.nextSibling, f1 = R1.firstChild;
    return d(G, () => $().map((S) => (() => {
      var X = uu(), q = X.firstChild, y1 = q.nextSibling, z1 = y1.firstChild;
      return X.addEventListener("blur", () => {
        ...
        return () => B1() && h(o0, {
          class: "list",
          get children() {
            return S.list.map((g1) => (() => {
              var m1 = I9(), _1 = m1.firstChild;
              return m1.$$click = () => {
                S.setter(g1.key), e.onDrawingItemClick({
                  name: g1.key,
                  lock: A(),
                  mode: b()
                }), x("");
      ...
      })(), null), R(() => J(z1, "class", S.key === N() ? "rotate" : "")), X;
    })()), i1), M.addEventListener("blur", () => {
      x("");
    }), D.$$click = () => {
      let S = c();
      b() !== "normal" && (S = "normal"), I(S), e.onModeChange(S);
    }, d(D, (() => {
      var S = H(() => c() === "weak_magnet");
      return () => S() ? H(() => b() === "weak_magnet")() ? h(W, {
        name: "weak_magnet",
        class: "selected"
      }) : h(W, {
        name: "weak_magnet"
      }) : H(() => b() === "strong_magnet")() ? h(W, {
        name: "strong_magnet",
        class: "selected"
      }) : h(W, {
        name: "strong_magnet"
      ...
      return () => S() && h(o0, {
        ...
        get children() {
          return B().map((X) => (() => {
            var q = I9(), y1 = q.firstChild;
            return q.$$click = () => {
              _(X.key), I(X.key), e.onModeChange(X.key), x("");
            }, d(q, h(W, {
              get name() {
                return X.key;
              }
      ...
      name: "remove"
    })), R(() => J(Q, "class", N() === "mode" ? "rotate" : "")), G;
  })();
};
r1(["click"]);
var P9 = /* @__PURE__ */ m("<li class=title>"), O9 = /* @__PURE__ */ m("<li class=row>");
const fu = (e) => h(P1, {
  get title() {
...
const gu = (e) => {
  const [t, n] = L(e.timezone), r = n1(() => yu(e.locale));
  return h(P1, {
    get title() {
...
var mu = /* @__PURE__ */ m("<div class=klinecharts-pro-setting-modal-content>"), hu = /* @__PURE__ */ m("<span>");
const du = (e) => {
  const [t, n] = L(e.currentStyles), [r, a] = L(E9(e.locale));
  s1(() => {
    a(E9(e.locale));
  });
  const s = (o, i) => {
...
var pu = /* @__PURE__ */ m("<img style=width:500px;margin-top:20px>");
const vu = (e) => h(P1, {
  get title() {
...
var Lu = /* @__PURE__ */ m("<div class=klinecharts-pro-indicator-setting-modal-content>"), bu = /* @__PURE__ */ m("<span>");
const $u = (e) => {
  const [t, n] = L(F.clone(e.params.calcParams)), r = (a) => _u[a];
  return h(P1, {
    get title() {
...
var xu = /* @__PURE__ */ m('<svg viewBox="0 0 1024 1024"><path d="M945.066667 898.133333l-189.866667-189.866666c55.466667-64 87.466667-149.333333 87.466667-241.066667 0-204.8-168.533333-373.333333-373.333334-373.333333S96 264.533333 96 469.333333 264.533333 842.666667 469.333333 842.666667c91.733333 0 174.933333-34.133333 241.066667-87.466667l189.866667 189.866667c6.4 6.4 14.933333 8.533333 23.466666 8.533333s17.066667-2.133333 23.466667-8.533333c8.533333-12.8 8.533333-34.133333-2.133333-46.933334zM469.333333 778.666667C298.666667 778.666667 160 640 160 469.333333S298.666667 160 469.333333 160 778.666667 298.666667 778.666667 469.333333 640 778.666667 469.333333 778.666667z">'), ku = /* @__PURE__ */ m("<img alt=symbol>"), Au = /* @__PURE__ */ m("<li><div><span>");
const wu = (e) => {
  const [t, n] = L(""), [r] = r6(t, e.datafeed.searchSymbols.bind(e.datafeed));
  return h(P1, {
    get title() {
    ...
    get children() {
      return [h(_5, {
        ...
        renderItem: (a) => (() => {
          var s = Au(), o = s.firstChild, i = o.firstChild;
          return s.$$click = () => {
            ...
            get children() {
              var l = ku();
              return R(() => J(l, "src", a.logo)), l;
            }
          }), i), d(i, () => a.shortName ?? a.ticker, null), d(i, () => `${a.name ? `(${a.name})` : ""}`, null), d(s, () => a.exchange ?? "", null), R(() => J(i, "title", a.name ?? "")), s;
        })()
      })];
    }
  });
...
r1(["click"]);
const Mu = "klinecharts-pro-overlays";
function Y0(e) {
  return `${Mu}-${e}`;
}
function Su(e) {
...
function Iu(e, t) {
  try {
    ...
    console.error("Failed to save overlays to localStorage:", n);
  }
}
function Du(e) {
  try {
    const t = Y0(e), n = localStorage.getItem(t);
    if (n)
      return JSON.parse(n);
  } catch (t) {
    console.error("Failed to load overlays from localStorage:", t);
  }
  return [];
}
function Pu(e) {
  try {
    ...
    console.error("Failed to clear overlays from localStorage:", t);
  }
}
class Ou {
  constructor(t, n) {
    u1(this, "symbol");
    u1(this, "cloudSyncProvider");
    this.symbol = t, this.cloudSyncProvider = n ?? null;
  }
  setSymbol(t) {
    this.symbol = t;
  }
  ...
  async syncToCloud() {
    if (this.cloudSyncProvider) {
      const t = this.load();
      await this.cloudSyncProvider.upload(this.symbol, t);
    }
  }
  async syncFromCloud() {
    if (this.cloudSyncProvider) {
      const t = await this.cloudSyncProvider.download(this.symbol);
      return this.save(t), t;
    }
    return [];
  }
}
var Bu = /* @__PURE__ */ m('<i class="icon-close klinecharts-pro-load-icon">'), Eu = /* @__PURE__ */ m("<div class=klinecharts-pro-content><div class=klinecharts-pro-widget>");
function G1(e, t, n, r) {
  return t === "VOL" && (r = {
    gap: {
      bottom: 2
...
const Nu = (e) => {
  var H0, G0;
  let t, n = null, r, a = !1;
  const s = ((H0 = e.overlayPersistence) == null ? void 0 : H0.enabled) ?? !1;
  let o = null;
  const i = /* @__PURE__ */ new Map();
  let l = null;
  s && (o = new Ou(e.symbol.ticker, (G0 = e.overlayPersistence) == null ? void 0 : G0.cloudSyncProvider));
  const [C, f] = L(e.theme), [c, _] = L(e.styles), [b, I] = L(e.locale), [A, K] = L(e.symbol), [w, Z] = L(e.period), [N, x] = L(!1), [$, B] = L([...e.mainIndicators]), [G, i1] = L({}), [M, D] = L(!1), [U, Q] = L({
    key: e.timezone,
    text: B9(e.timezone, e.locale)
  }), [t1, O1] = L(!1), [j1, Z1] = L(), [Q1, R1] = L(""), [f1, S] = L(e.drawingBarVisible), [X, q] = L(!1), [y1, z1] = L(!1), [B1, g1] = L({
    visible: !1,
    indicatorName: "",
    paneId: "",
    calcParams: []
  ...
  const m1 = () => {
    ...
    if (s && o && n) {
      i.forEach((y, v) => {
        const p = n.getOverlayById(v);
        p && i.set(v, p);
      });
      const g = Array.from(i.values()).map(Su);
      o.save(g);
    }
  }, b5 = () => {
    s && !l && (l = window.setInterval(() => {
      i.size > 0 && _1();
    }, 2e3));
  }, $5 = () => {
    ...
    s && o && n && o.load().forEach((y) => {
      ...
      (Array.isArray(p) ? p.filter((j) => j != null) : p ? [p] : []).forEach((j) => {
        const z = n.getOverlayById(j);
        z && i.set(j, z);
      });
    });
  }, x5 = (g) => {
    if (s && n) {
      const y = n.getOverlayById(g);
      y && i.set(g, y);
    }
  }, k5 = (g) => {
    s && (i.delete(g), _1());
    ...
    switch (g.timespan) {
      case "minute": {
        p = p - p % (60 * 1e3), k = p - v * g.multiplier * 60 * 1e3;
        break;
      }
      case "hour": {
        p = p - p % (60 * 60 * 1e3), k = p - v * g.multiplier * 60 * 60 * 1e3;
        break;
      }
      case "day": {
        p = p - p % (60 * 60 * 1e3), k = p - v * g.multiplier * 24 * 60 * 60 * 1e3;
        break;
      }
      case "week": {
        const z = new Date(p).getDay(), h1 = z === 0 ? 6 : z - 1;
        p = p - h1 * 60 * 60 * 24;
        const L1 = new Date(p);
        p = (/* @__PURE__ */ new Date(`${L1.getFullYear()}-${L1.getMonth() + 1}-${L1.getDate()}`)).getTime(), k = v * g.multiplier * 7 * 24 * 60 * 60 * 1e3;
        break;
      }
      case "month": {
        const j = new Date(p), z = j.getFullYear(), h1 = j.getMonth() + 1;
        p = (/* @__PURE__ */ new Date(`${z}-${h1}-01`)).getTime(), k = v * g.multiplier * 30 * 24 * 60 * 60 * 1e3;
        const L1 = new Date(k);
        k = (/* @__PURE__ */ new Date(`${L1.getFullYear()}-${L1.getMonth() + 1}-01`)).getTime();
        break;
      }
      case "year": {
        const z = new Date(p).getFullYear();
        p = (/* @__PURE__ */ new Date(`${z}-01-01`)).getTime(), k = v * g.multiplier * 365 * 24 * 60 * 60 * 1e3;
        const h1 = new Date(k);
        k = (/* @__PURE__ */ new Date(`${h1.getFullYear()}-01-01`)).getTime();
        break;
      }
    }
    return [k, p];
  ...
  return j9(() => {
    if (window.addEventListener("resize", m1), n = S5(t, {
      customApi: {
        formatDate: (y, v, p, k) => {
          switch (w().timespan) {
            case "minute":
              return k === U1.XAxis ? F.formatDate(y, v, "HH:mm") : F.formatDate(y, v, "YYYY-MM-DD HH:mm");
            case "hour":
              return k === U1.XAxis ? F.formatDate(y, v, "MM-DD HH:mm") : F.formatDate(y, v, "YYYY-MM-DD HH:mm");
            case "day":
            case "week":
              return F.formatDate(y, v, "YYYY-MM-DD");
            case "month":
              return k === U1.XAxis ? F.formatDate(y, v, "YYYY-MM") : F.formatDate(y, v, "YYYY-MM-DD");
            case "year":
              return k === U1.XAxis ? F.formatDate(y, v, "YYYY") : F.formatDate(y, v, "YYYY-MM-DD");
          }
          return F.formatDate(y, v, "YYYY-MM-DD HH:mm");
        }
      }
    }), n) {
      ...
      if (y) {
        ...
        if (p.className = "klinecharts-pro-watermark", F.isString(e.watermark)) {
      ...
      const v = n.getDom("candle_pane", X0.YAxis);
    ...
    e.subIndicators.forEach((y) => {
      const v = G1(n, y, !0);
      v && (g[y] = v);
    }), i1(g), V0(), b5(), n == null || n.loadMore((y) => {
      a = !0, (async () => {
        const p = w(), [k] = h0(p, y, 1), [j] = h0(p, k, 500), z = await e.datafeed.getHistoryKLineData(A(), p, j, k);
        n == null || n.applyMoreData(z, z.length > 0), a = !1;
      })();
    }), n == null || n.subscribeAction(T5.OnTooltipIconClick, (y) => {
      if (y.indicatorName)
        switch (y.iconId) {
          case "visible": {
          ...
          case "close":
            if (y.paneId === "candle_pane") {
              const v = [...$()];
              n == null || n.removeIndicator("candle_pane", y.indicatorName), v.splice(v.indexOf(y.indicatorName), 1), B(v);
            } else {
              const v = {
                ...G()
              };
              n == null || n.removeIndicator(y.paneId, y.indicatorName), delete v[y.indicatorName], i1(v);
            }
        }
    });
  }), I0(() => {
    $5(), window.removeEventListener("resize", m1), I5(t);
  }), s1(() => {
    const g = A();
    ...
    if (!a) {
      g && (e.datafeed.unsubscribe(g.symbol, g.period), s && g.symbol.ticker !== A().ticker && (n == null || n.removeOverlay(), A5()));
      const y = A(), v = w();
      return s && o && o.setSymbol(y.ticker), a = !0, z1(!0), (async () => {
        const [k, j] = h0(v, (/* @__PURE__ */ new Date()).getTime(), 500), z = await e.datafeed.getHistoryKLineData(y, v, k, j);
        n == null || n.applyNewData(z, z.length > 0), e.datafeed.subscribe(y, v, (h1) => {
          n == null || n.updateData(h1);
        }), s && g && g.symbol.ticker !== y.ticker && V0(), a = !1, z1(!1);
      })(), {
        symbol: y,
        period: v
      };
    ...
    n == null || n.setLocale(b());
  }), s1(() => {
    n == null || n.setTimezone(U().key);
  }), s1(() => {
    c() && (n == null || n.setStyles(c()), Z1(Ur(n.getStyles())));
  }), [Bu(), h(Y, {
    get when() {
      return X();
    },
    ...
    get children() {
      return h(fu, {
        ...
        onMainIndicatorChange: (g) => {
          const y = [...$()];
          g.added ? (G1(n, g.name, !0, {
            id: "candle_pane"
          }), y.push(g.name)) : (n == null || n.removeIndicator("candle_pane", g.name), y.splice(y.indexOf(g.name), 1)), B(y);
        },
        onSubIndicatorChange: (g) => {
          ...
          if (g.added) {
            ...
            g.paneId && (n == null || n.removeIndicator(g.paneId, g.name), delete y[g.name]);
          i1(y);
        }
      });
    }
    ...
    get children() {
      return h(du, {
        ...
        onRestoreDefault: (g) => {
          ...
          g.forEach((v) => {
            const p = v.key;
            k0(y, p, F.formatValue(j1(), p));
          }), n == null || n.setStyles(y);
        }
      });
    }
  }), h(Y, {
    ...
    d(g, h(Y, {
      ...
      get children() {
        return h(Cu, {
          ...
          onDrawingItemClick: (p) => {
            const k = n == null ? void 0 : n.createOverlay(p);
            k && (Array.isArray(k) ? k.filter((z) => z != null) : [k]).forEach((z) => x5(z));
          },
          onModeChange: (p) => {
          ...
          onRemoveClick: (p) => {
            const k = Array.from(i.values()).filter((j) => j.groupId === p).map((j) => j.id);
  ...
  constructor(t) {
    ...
    this._container.classList.add("klinecharts-pro"), this._container.setAttribute("data-theme", t.theme ?? "light"), d6(() => {
      ...
      return h(Nu, {
        ...
        get overlayPersistence() {
          return t.overlayPersistence;
        }
      });
    }, this._container);
  }
...
export {
  ...
  zu as KLineChartPro,
  Ou as OverlayStorage,
  Pu as clearOverlaysFromLocalStorage,
  Tu as deserializeOverlay,
  Ru as loadLocales,
  Du as loadOverlaysFromLocalStorage,
  Iu as saveOverlaysToLocalStorage,
  Su as serializeOverlay
};
